...
class Order:
    ...
    >>> Order(joe, long_order, Promotion.large_order_promo)
    <Order total: 10.00 due: 9.30>
    >>> Order(ann, cart, Promotion.large_order_promo)
    <Order total: 42.00 due: 42.00>
    >>> Order(joe, long_order, Promotion)
    <Order total: 10.00 due: 9.30>
    >>> Order(ann, long_order, Promotion)
    <Order total: 10.00 due: 9.30>
    """
...
class Promotion:
    ...
    def best_promo(self, order):
        promos = [self.fidelity_promo, self.bulk_item_promo, self.large_order_promo]
